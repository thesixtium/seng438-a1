...
During the peer review processes,bug reports were reviewreviewed by other group memebers to check the clarity, completeness, and reproducibility. Feedback mainly focused on making reproduction steps and bug summaries more precise,clearly separating expected versus actual behavior, and keeping bug titles concise and descriptive.
In some casses more steps for bug reprucdtion was added to increase reproduction acuuracy.
Peer review helped identify areas where defect reports could be clearer and more precise. Based on the feedback received, reports were refined to better describe system state, preconditions, and outcomes.
...
The lab provided a clear and practical introduction to exploratory, manual, and regression testing. The lab document was well organized and easy to follow, with helpful appendices and test cases.
